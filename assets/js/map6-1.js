$( document ).ready(function() {
  ...
  var map = new mapboxgl.Map({
      container: 'figure6-1', // container id
  ...
  map.on('load', function () {
    ...
    map.addSource('schematic', {
        type: 'geojson',
        "data": '../assets/js/geojson/leydenRecPlan.geojson'
    });
...
// the feature, with description HTML from its properties.
  map.on('click', function (e) {
    ...
    var popup = new mapboxgl.Popup()
        ...
        .setHTML('<b>Reach ' + feature.properties.reach + '</b><hr><p><b>Location: </b>' + feature.properties.title + '<br>' + feature.properties.description + '</p>')
        .addTo(map);
  });
